  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-surface border border-primary/10 rounded-xl p-6">
        <h2 className="text-lg font-semibold text-text mb-4">Usuarios y Roles</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-primary/10">
                <th className="text-left py-3 px-2 font-medium text-muted">Email</th>
                <th className="text-left py-3 px-2 font-medium text-muted">Nombre</th>
                <th className="text-left py-3 px-2 font-medium text-muted">Roles</th>
                <th className="text-right py-3 px-2 font-medium text-muted">Acciones</th>
              </tr>
            </thead>
            <tbody>
              {users.map(u => (
                <tr key={u.user_id} className="border-b border-primary/5">
                  <td className="py-3 px-2 text-text">{u.email}</td>
