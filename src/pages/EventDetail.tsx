...
export default function EventDetail() {
  ...
  useEffect(() => {
    ...
    map.on('load', () => new maplibregl.Marker({ color: getComputedStyle(document.documentElement).getPropertyValue('--th-primary').trim() || '#6366F1' }).setLngLat([event.lng, event.lat]).addTo(map))
