...
const _INJECTED_PREFIX = '(function(){var _ce=console.error;console.error=function(){var m=Array.prototype.map.call(arguments,String).join(" ");if(m.includes("Expected value to be of type number")||m.includes("/rpc/check_streak"))return;_ce.apply(console,arguments)};var _ae=self.addEventListener;self.addEventListener=function(t,l,o){if(t==="message"&&typeof l==="function"){var w=function(e){try{return l(e)}catch(ex){if(ex&&typeof ex.message==="string"&&ex.message.includes("Expected value to be of type number, but found null"))return;throw ex}};return _ae.call(self,t,w,o)}return _ae.apply(self,arguments)};var _om=null;Object.defineProperty(self,"onmessage",{get:function(){return _om},set:function(f){if(typeof f==="function"){_om=function(e){try{return f(e)}catch(ex){if(ex&&typeof ex.message==="string"&&ex.message.includes("Expected value to be of type number, but found null"))return;throw ex}}}else{_om=f}},configurable:true});self.addEventListener("error",function(e){if(e&&typeof e.message==="string"&&e.message.includes("Expected value to be of type number, but found null")){e.preventDefault();e.stopPropagation()}});self.addEventListener("unhandledrejection",function(e){if(e.reason&&typeof e.reason.message==="string"&&e.reason.message.includes("Expected value to be of type number, but found null"))e.preventDefault()});})();'
